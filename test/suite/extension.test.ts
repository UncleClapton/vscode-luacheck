...
suite("luacheck Tests", () => {
    ...
    test("bad_code.lua", () => {
        ...
        assert.deepEqual(reports, expect)
    ...
    test("compat.lua", () => {
        ...
        let reports = checker.check(CHECK_DATA);
        let expect: luacheck.report[] = [{ "code": "113", "column": 2, "end_column": 8, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }, { "code": "113", "column": 14, "end_column": 19, "line": 1, "name": "rawlen", "message": "accessing undefined variable 'rawlen'" }, { "code": "113", "column": 22, "end_column": 28, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }, { "code": "113", "column": 34, "end_column": 39, "line": 1, "name": "rawlen", "message": "accessing undefined variable 'rawlen'" }]
        assert.deepEqual(reports, expect)
    });
    test("defined.lua", () => {
    ...
    test("globals.lua", () => {
        ...
        let reports = checker.check(CHECK_DATA);
        let expect: luacheck.report[] = [{ "code": "113", "column": 7, "end_column": 13, "line": 1, "name": "setfenv", "message": "accessing undefined variable 'setfenv'" }, { "code": "113", "column": 15, "end_column": 20, "line": 1, "name": "rawlen", "message": "accessing undefined variable 'rawlen'" }]
        assert.deepEqual(reports, expect)
    });
    test("good_code.lua", () => {
